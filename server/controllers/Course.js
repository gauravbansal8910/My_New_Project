  ...
  exports.searchCourse = async (req, res) => {
	...
	//   console.log("searchQuery : ", searchQuery)
	  const courses = await Course.find({
		$or: [				// Specifies an OR condition, meaning any of the conditions inside the $or array can be true for the course to be included in the result.
			// regex : Allows pattern matching using a regular expression.
			// Useful for partial or flexible text matches (e.g., searching for "math" can match "Mathematics").
